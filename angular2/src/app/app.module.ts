...
@NgModule({
  declarations: [
    ...
    CochesComponent, PedidosComponent, UsuariosComponent, InsertarCocheComponent, InsertarUsuarioComponent, InicioSesionComponent, NavbarUsersComponent, NavbarAdminComponent, NavbarInicioSesionComponent, // Declaramos el componente de coches
  ],
  imports: [
    BrowserModule,
